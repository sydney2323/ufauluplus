...
<div class="card">
  <div class="card-header d-flex">
    <h3 class="card-title">A-level online Quiz</h3>
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            type : 'GET',
		      	url : '/admin-quiz-alevel/'+quiz_id+'/edit',
            dataType : "json",
	      		success : function(response){
                if (response.status == 200) {
                    $('#edit_subject').val(response.quizAlevel.subject); 
